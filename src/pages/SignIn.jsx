...
const SignIn = () => {
  return (
    <div className=' w-full h-screen top-0 relative'>
      <img 
      className='w-full h-screen object-cover bg-gradient-l from-black'
      src='blackish.jpg'
      alt=''
      />
      <div
      ...
      >
        ...
        <div className='block sm:flex items-center  gap-2 mt-7 cursor-pointer'>
          ...
          <button 
          type='submit' 
          className='inline-block p-2 w-full text-md md:text-xl bg-red-600 text-white rounded-md my-2 capitalize mx-auto '>
            sign in
          </button>
        </div>
